			...
			<div class="col-lg-9">
				<fieldset class="Form"
					...
					<table width="800" align="center">
						<tr height="100">
							<td align="center" style="font-size: xx-large;"><b>[풋살 구장
									수정 페이지]</b></td>
						</tr>
					</table>
				</fieldset> 
				
			<form class="Form" action="${pageContext.request.contextPath}/footsal/update"
		...
		<fieldset style="width: 800px; margin: auto;">
			<table width="800" height="600" cellpadding="0"
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="hidden" name="id" value="${footsal.id}">
						<input type="file" name="file" value="${footsal.footsalImg}" multiple required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="footsalAddress" value="${footsal.footsalAddress}" placeholder="구장 주소" required><br></td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				</tr>
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="footsalName" value="${footsal.footsalName}" placeholder="구장 이름" required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="footsalPhone" value="${footsal.footsalName}" placeholder="구장 연락처" required><br>
					</td>
				<tr height="7">
					<td colspan="3"><hr /></td>
				</tr>
				<tr class="register" height="30">
					...
					<th width="20%">대여료 :</th>
					<th>
						<input type="number" name="footsalPrice" value="${footsal.footsalPrice}" placeholder="구장 대여료" required><br>
					</th>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="footsalCoordinatesl" value="${footsal.footsalCoordinatesl}" placeholder="구장 좌표" required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
