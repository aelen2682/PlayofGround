			...
			<div class="col-lg-9">
				<fieldset class="Form" style="width: 800px; height: 125px; margin: auto;">
					<table width="800" align="center">
						<tr height="100">
							<td align="center" style="font-size: xx-large;"><b>[BasketBall
									구장 등록]</b></td>
						</tr>
					</table>
				</fieldset>
				
				<form action="${pageContext.request.contextPath}/basketball/insert" method="post" enctype="multipart/form-data">
		<fieldset class="Form" style="width: 800px; margin: auto;">
			<table width="800" height="600" cellpadding="0" style="border-collapse: collapse; font-size: 9pt;" align="center">
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="basketballAddress" placeholder="구장 주소" required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="basketballName" placeholder="구장 이름" required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						 <input type="text" name="basketballPhone" placeholder="구장 연락처" required><br>
					</td>
				<tr height="7">
					<td colspan="3"><hr /></td>
				</tr>
				<tr class="register" height="30">
					...
					<th width="20%">대여료 : </th>
					<th>
						<input type="number" name="basketballPrice" placeholder="구장 대여료" required><br>
					</th>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="basketballCoordinatesl" placeholder="구장 좌표" required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
