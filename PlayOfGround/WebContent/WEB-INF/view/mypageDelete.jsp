...
<%@ page import="service.Page_UserSerivce" %>
<%
      ...
      <div class="row">
         ...
         <div class="col-lg-3">
            ...
            <div class="list-group">
               <a href="http://localhost:8090/MyPage/Information" class="list-group-item"><font
                  color=black><i class="far fa-futbol"></i>회원정보 수정</font></a> <a
                  href="http://localhost:8090/reservation/list" class="list-group-item"><font
                  color=#005666><i class="fas fa-futbol"></i>예약 현황</font></a> <a
            ...
            <div id="messageWindow2"
               style="padding: 10px 0; height: 25em; overflow: auto; background-color: white;">
            </div>
         </div>
         <!-- /.col-lg-3 -->
...
%>
   <form name="deleteInfo" action="/MyPage/Delete" method="post">
      <fieldset class="Form" style="width: 800px; margin: auto;">
         ...
         <table width="700" height="400" cellpadding="0"
            ...
            <tr class="register" height="30">
               ...
               <th width="20%" style="text-align: left;">비밀번호 :</th>
               <td><input type="password" name="password" id="password"
                  onchange="pwCheck()" checked /><br></td>
            </tr>
            <tr height="7">
               <td colspan="3"><hr /></td>
            </tr>
            <tr class="register" height="30">
               <td width="20%" align="center">*</td>
               <th width="20%" style="text-align: left;">비밀번호 확인 :</th>
   ...
   %>
   <form name="apideleteInfo" action="/MyPage/APIDelete" method="post">
      <fieldset style="width: 800px; margin: auto;">
         <table width="800" align="center">
            <tr height="1">
               <td align="center" style="font-size: xx-large;"><b>[내 계정 탈퇴]</b></td>
            </tr>
         </table>
         <table width="700" height="400" cellpadding="0"
            style="border-collapse: collapse; font-size: 9pt;" align="center">
            ...
            <tr class="register" height="30">
               <td width="20%" align="center">*</td>
               <th width="20%" style="text-align: left;">이름 :</th>
               <td><input type="text" name="name" id="name"
                  onchange="nameCheck()" checked /><br></td>
            </tr>
            <tr height="7">
               <td colspan="3"><hr /></td>
            </tr>
            <tr class="register" height="30">
               <td width="20%" align="center">*</td>
               <th width="20%" style="text-align: left;">핸드폰 번호 :</th>
               <td><input type="tel" name="phone" id="phone"
                  onchange="phoneCheck()" checked /><br></td>
            </tr>
            <tr height="7">
               <td colspan="3"><hr /></td>
            </tr>
            ...
            <tr class="register" height="30">
               <th colspan="3" style="text-align: center;">
               <input id="apidelte_btn" type="submit" value="탈퇴"> 
              </th>
            </tr>
         </table>
      </fieldset>
