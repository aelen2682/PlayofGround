...
<body id="id01">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-9">
				<fieldset class="Form"
					style="width: 825px; height: 125px; margin: auto;">
					<table width="800" align="center">
						<tr height="100">
							<td align="center" style="font-size: xx-large;"><b>[축구 구장
									수정 페이지]</b></td>
						</tr>
					</table>
				</fieldset>
				<form  class="Form" action="${pageContext.request.contextPath}/soccer/update"
					...
					<fieldset style="width: 800px; margin: auto;">
						<table width="800" height="600" cellpadding="0"
							...
							<tr class="register" height="30">
								...
								<th width="15%">Soccer Img :</th>
								<td><input type="hidden" name="id" value="${soccer.id}">
									<input type="file" name="file" value="${soccer.soccerImg}"
									multiple required><br></td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							</tr>
							<tr class="register" height="30">
								...
								<td><input type="text" name="soccerAddress"
									value="${soccer.soccerAddress}" placeholder="구장 주소" required><br>
								</td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							...
							<tr class="register" height="30">
								...
								<td><input type="text" name="soccerName"
									value="${soccer.soccerName}" placeholder="구장 이름" required><br>
								</td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							...
							<tr class="register" height="30">
								...
								<td><input type="text" name="soccerPhone"
									value="${soccer.soccerPhone}" placeholder="구장 연락처" required><br>
								</td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							...
							<tr class="register" height="30">
								<td width="15%" align="center">*</td>
								<th width="20%">구장 규격 :</th>
								<th><input type="text" name="soccerStandard"
									value="${soccer.soccerStandard}" placeholder="구장 규격" required><br>
								</th>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							...
							<tr class="register" height="30">
								<td width="15%" align="center">*</td>
								<th width="20%">대여료 :</th>
								<th><input type="number" name="soccerPrice"
									value="${soccer.soccerPrice}" placeholder="구장 대여료" required><br>
								</th>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							...
							<tr class="register" height="30">
								...
								<td><input type="text" name="soccerCoordinatesl"
									value="${soccer.soccerCoordinatesl}" placeholder="구장 좌표"
									required><br></td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							...
							<tr class="register" height="30">
								<td width="15%" align="center">*</td>
								<th width="20%">잔 디 :</th>
								<td>천연 : <input type="radio" name="soccerGrass" value="1"
									required> 인조 : <input type="radio" name="soccerGrass"
									value="0"><br>
								</td>
							</tr>
							<tr height="7">
							...
							<tr class="register" height="30">
								<td width="15%" align="center">*</td>
								<th width="20%">조 명 :</th>
								<td>있음 : <input type="radio" name="soccerLighting"
									value="1" required> 없음 : <input type="radio"
									name="soccerLighting" value="0"><br>
								</td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							...
							<tr class="register" height="30">
								...
								<td>있음 : <input type="radio" name="soccerParking" value="1"
									required> 없음 : <input type="radio" name="soccerParking"
									value="0"><br>
								</td>
							</tr>
							<tr height="7">
							...
							<tr class="register" height="30">
								...
								<td>있음 : <input type="radio" name="soccerShower" value="1"
									required> 없음 : <input type="radio" name="soccerShower"
									value="0"><br>
								</td>
							</tr>
							<tr height="7">
							...
							<tr class="register" height="30">
								<th colspan="3" style="text-align: center;"><input
									type="submit" value="수정"> <input type="submit"
									onclick="Cancellation()" value="취소"></th>
							</tr>
						</table>
						<br />
					</fieldset>
