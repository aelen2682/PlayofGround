			...
			<div class="col-lg-9">
				<fieldset class="Form" style="width: 800px; height: 125px; margin: auto;">
					<table width="800" align="center">
						<tr height="100">
							<td align="center" style="font-size: xx-large;"><b>[Soccer
									구장 등록]</b></td>
						</tr>
					</table>
				</fieldset>
				<form action="${pageContext.request.contextPath}/soccer/insert"
					...
					<fieldset class= "Form" style="width: 800px; margin: auto;">
						<table width="800" height="600" cellpadding="0"
							...
							<tr class="register" height="30">
								...
								<td><input type="file" name="file" multiple required><br>
								</td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							...
							<tr class="register" height="30">
								...
								<td><input type="text" name="soccerAddress"
									placeholder="구장 주소" required><br></td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							</tr>
							<tr class="register" height="30">
								...
								<td><input type="text" name="soccerName"
									placeholder="구장 이름" required><br></td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							</tr>
							<tr class="register" height="30">
								...
								<td><input type="text" name="soccerPhone"
									placeholder="구장 연락처" required><br></td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							</tr>
							<tr class="register" height="30">
								...
								<th><input type="text" name="soccerStandard"
									placeholder="구장 규격" required><br></th>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							</tr>
							<tr class="register" height="30">
								...
								<th><input type="number" name="soccerPrice"
									placeholder="구장 대여료" required><br></th>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							</tr>
							<tr class="register" height="30">
								...
								<td><input type="text" name="soccerCoordinatesl"
									placeholder="구장 좌표" required><br></td>
							</tr>
							<tr height="7">
								<td colspan="3"><hr /></td>
							</tr>
							...
							<tr class="register" height="30">
								<th colspan="3" style="text-align: center;"><input
									type="submit" value="등록"> <input type="submit"
