	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-9" style="border: 1px solid #49505733;">
				<fieldset
					style="width: 800px; height: 125px; margin: auto;">
					<table width="800" align="center">
						<tr height="100">
							<td align="center" style="font-size: xx-large;"><b>[자유롭게
									매칭을 할수있는 게시판입니다 ]</b></td>
						</tr>
					<tr id="wirte_btn">
					...
					<div id="col-lg-9">
						<fieldset class="Form"
							style="width: 800px; height: 125px; margin: auto; margin-top: 20px;">
							<table>
								<thead>
									<tr>
										<th width="70">번호</th>
