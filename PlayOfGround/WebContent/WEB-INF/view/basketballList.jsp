	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<div class="row">
					<c:forEach var="basketball" items="${basketballList}">
						<div class="col-lg-4 col-md-6 mb-4">
							<div class="card h-100">
								<a href="detail?id=${basketball.id}"><img class="card-img-top"
									src="${pageContext.request.contextPath}/basketball_img/${basketball.basketballImg}" alt=""></a>
								<div class="card-body">
									<h4 class="card-title">
										<a href="detail?id=${basketball.id}">${basketball.basketballName}</a>
									</h4>
									<h5>${basketball.basketballAddress}</h5>
									<p class="card-text">Lorem ipsum dolor sidt amet,
										consectetur adipisicing elit. Amet numquam aspernatur!</p>
									<a href="detail?id=${basketball.id}"><button>상세페이지</button></a>
								</div>
							</div>
						</div>
					</c:forEach>
