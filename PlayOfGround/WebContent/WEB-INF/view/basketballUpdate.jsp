			...
			<div class="col-lg-9">
				<fieldset class="Form"
					...
					<table width="800" align="center">
						<tr height="100">
							<td align="center" style="font-size: xx-large;"><b>[농구 구장
									수정 페이지]</b></td>
						</tr>
					</table>
				</fieldset>
				
				<form action="${pageContext.request.contextPath}/basketball/update" method="post" enctype="multipart/form-data">
		<fieldset class="Form" style="width: 800px; margin: auto;">
			<table width="800" height="600" cellpadding="0" style="border-collapse: collapse; font-size: 9pt;" align="center">
				<tr class="register" height="30">
					...
					<th width="15%">Basketball Img : </th>
					<td>
						<input type="hidden" name="id" value="${basketball.id}">
						<input type="file" name="file" value="${basketball.basketballImg}" multiple required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="basketballAddress" value="${basketball.basketballAddress}" placeholder="구장 주소" required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="basketballName" value="${basketball.basketballName}" placeholder="구장 이름" required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						 <input type="text" name="basketballPhone" value="${basketball.basketballPhone}" placeholder="구장 연락처" required><br>
					</td>
				<tr height="7">
					<td colspan="3"><hr /></td>
				</tr>
				<tr class="register" height="30">
					...
					<th width="20%">대여료 : </th>
					<th>
						<input type="number" name="basketballPrice" value="${basketball.basketballPrice}" placeholder="구장 대여료" required><br>
					</th>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
						<input type="text" name="basketballCoordinatesl" value="${basketball.basketballCoordinatesl}" placeholder="구장 좌표" required><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					<td width="15%" align="center">*</td>
					<th width="20%">바닥 재질 : </th>
					<td>
					마루목재 : <input type="radio" name="basketballFloor" value="1" required>
		  			인도어 : <input type="radio" name="basketballFloor" value="0"><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
					있음 : <input type="radio" name="basketballParking" value="1" required>
					없음 : <input type="radio" name="basketballParking" value="0"><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
					있음 : <input type="radio" name="basketballFacility" value="1" required>
		  			없음 : <input type="radio" name="basketballFacility" value="0"><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
				...
				<tr class="register" height="30">
					...
					<td>
					있음 : <input type="radio" name="basketballShower" value="1" required>
					없음 : <input type="radio" name="basketballShower" value="0"><br>
					</td>
				</tr>
				<tr height="7">
					<td colspan="3"><hr /></td>
