	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<div class="row">
					<c:forEach var="footsal" items="${footsalList}">
						<div class="col-lg-4 col-md-6 mb-4">
							<div class="card h-100">
								<a href="detail?id=${footsal.id}"><img class="card-img-top"
									src="${pageContext.request.contextPath}/footsal_img/${footsal.footsalImg}" alt=""></a>
								<div class="card-body">
									<h4 class="card-title">
										<a href="detail?id=${footsal.id}">${footsal.footsalName}</a>
									</h4>
									<h5>${footsal.footsalAddress}</h5>
									<p class="card-text">Lorem ipsum dolor sidt amet,
										consectetur adipisicing elit. Amet numquam aspernatur!</p>
									<a href="detail?id=${footsal.id}"><button>상세페이지</button></a>
								</div>
							</div>
						</div>
					</c:forEach>
